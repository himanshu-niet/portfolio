...
<nav className='py-10  mb-12 flex justify-between'>
  ...
  <ul className='flex items-center'>
    ...
    <li className='bg-gradient-to-r from-cyan-500 to-teal-500 text-white px-4 py-2 rounded-md ml-8'> <a href='https://drive.google.com/file/d/1DH4sewh4_zLIqyq3IzTXB-9gHJpgDsyV/view?usp=sharing' download >Resume</a></li>
